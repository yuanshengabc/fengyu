...
import cn.deepclue.common.response.Response;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<Object> handleException(Exception ex, WebRequest webRequest, HttpServletRequest request) {
        ...
        HttpStatus status = getStatus(request);
        String errMsg = status.getReasonPhrase() + ": " + ex.getMessage();
        //new Response<>(status.value(), errMsg)
        return super.handleExceptionInternal(ex, errMsg, new HttpHeaders(), status, webRequest);
    }
